# 기사단원의 무기
### [Lv.1 - 136798](https://school.programmers.co.kr/learn/courses/30/lessons/136798)
...
- 2 ≤ `limit` ≤ 100
- 1 ≤ `power` ≤ `limit`
## 풀이(Brute Force, Mathematics)
- 약수의 개수를 구할 때 일일이 하나씩 구하면 나중에 많은 수를 다룰 때 연산 시간이 오래 걸리게 된다.
- 이를 해결하기 위해 제곱근 형식으로 문제를 풀면 중복된 제곱근을 제외하고는 나머지 연산이 0일 때 둘씩 카운트 하면 된다.
...
public class Solution {
    ...
    {
        int divisorCount = 0;
        // 연산 수를 줄이기 위한 제곱근 형식으로 약수의 개수 구하기
